        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
               ...
               modelBuilder.Entity<Language>().HasData(
                new List<Language>()
                {
                    new Language{Name = " JavaScript", LanguageId = 1},
                    new Language{Name = "Html", LanguageId = 2},
                    new Language{Name = "Java", LanguageId = 3},
                    new Language{Name = "C#", LanguageId = 4}
                }
                );
            ...
            modelBuilder.Entity<Choice>().HasData(
                new List<Choice>
                {
                    new Choice {Name = "JavaScript is the programming language of Html and the Web.", Id = 1, QuestionId = 1, IsAnswer = true},
                    new Choice {Name = "JavaScript is an excerpt from The Raven.", Id = 2, QuestionId = 1, IsAnswer = false},
                    new Choice {Name = "JavaScript is a musical play.", Id = 3, QuestionId = 1, IsAnswer = false},
                    new Choice {Name = "JavaScript is  the name of a pharmacy ", Id = 4, QuestionId = 1, IsAnswer = false},
                    ...
                    new Choice {Name = "A general purpose computer programing language", Id = 17, QuestionId = 5, IsAnswer = true},
                    ...
                    new Choice {Name = "Scanner input = new Scanner(System.in);", Id = 21, QuestionId = 6, IsAnswer = true},
                    ...
                    new Choice {Name = "A mutliparadigm powerful programming language which uses features such as strong typing", Id = 25, QuestionId = 7, IsAnswer = true},
                    new Choice {Name = "A noise you make when you stub your toe", Id = 26, QuestionId = 7, IsAnswer = false},
